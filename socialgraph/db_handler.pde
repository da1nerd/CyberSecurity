...
class DBManager {
  ...
  ArrayList<Person> peopleWithConnections(int min_degree, int max_degree, String required_backward_connections_set, int min_degree_to_prev, int max_degree_to_prev, String required_forward_connections_set, int min_degree_to_next, int max_degree_to_next) {
